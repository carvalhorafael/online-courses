...
MAIN_FILE="${ROOT_DIR}/online-courses.php"
...
perl -0pi -e "s/define\\( 'ONLINE_COURSES_VERSION', '\\Q${current_version}\\E' \\);/define( 'ONLINE_COURSES_VERSION', '${next_version}' );/" "${MAIN_FILE}"
